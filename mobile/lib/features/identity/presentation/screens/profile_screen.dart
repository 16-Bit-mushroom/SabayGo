...
import 'package:mobile/features/dashboard/presentation/screens/subscription_screen.dart';
                ...
                onTap: () {
                  if (isVerified) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                          "Please verify your identity before applying to drive.",
                        ),
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              "Share fuel costs directly with commuters.",
                              style: TextStyle(
                                color: Colors.white70,
                                fontSize: 12,
                              ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Look for the "Upgrade to Premium" SettingsTile
                  SettingsTile(
              ...
              child: Column(
                children: [
                  ...
                  SettingsTile(
                    ...
                    iconColor: Colors.red,
                    title: "Sign Out",
                    onTap: () => _showSignOutConfirmation(context, viewModel),
                  ),
                ],
              ),
            ),
